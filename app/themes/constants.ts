...
import {
  ...
  MAX_GENERATE_MORE_WORD_COUNT as MAX_GENERATE_MORE_WORD_COUNT_FROM_LIB,
...
export const DEFAULT_GENERATE_MORE_WORD_COUNT = 5;
export const MAX_GENERATE_MORE_WORD_COUNT = MAX_GENERATE_MORE_WORD_COUNT_FROM_LIB;
