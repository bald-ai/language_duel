...
CASES = [
    ...
    ('coverage-deleted-source', 'scripts/quality-metrics.mjs', '...Object.keys(manifest.sourceHashes)', '...[]', 'tests/tooling/qualityMetrics.test.ts'),
    ...
    ("coverage-digest-provenance", "scripts/quality-metrics.mjs", 'manifest.coverageSha256 === coverageDigest', 'true', "tests/tooling/qualityMetrics.test.ts"),
